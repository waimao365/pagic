...
export default {
    ...
    'outputPath': "posts/ubuntu安装hugo教程.html",
    'title': "ubuntu安装hugo教程",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h2 id="ubuntu%E5%AE%89%E8%A3%85hugo">ubuntu安装hugo<a class="anchor" href="#ubuntu%E5%AE%89%E8%A3%85hugo">§</a></h2>\n<h3 id="%E5%AE%89%E8%A3%85git">安装git<a class="anchor" href="#%E5%AE%89%E8%A3%85git">§</a></h3>\n<p>官网 <a href="https://git-scm.com/download/linux">https://git-scm.com/download/linux</a></p>\n<p>sudo apt-get install git</p>\n<h3 id="%E5%AE%89%E8%A3%85go">安装go<a class="anchor" href="#%E5%AE%89%E8%A3%85go">§</a></h3>\n<p><a href="https://golang.org/dl/">https://golang.org/dl/</a>     （有可能被墙）</p>\n<p>下载go1.15.8.linux-amd64.tar.gz</p>\n<pre class="language-autoit"><code class="language-autoit">sudo tar <span class="token operator">-</span>C <span class="token operator">/</span>usr<span class="token operator">/</span><span class="token keyword">local</span> <span class="token operator">-</span>xzf go1<span class="token punctuation">.</span><span class="token number">15.8</span><span class="token punctuation">.</span>linux<span class="token operator">-</span>amd64<span class="token punctuation">.</span>tar<span class="token punctuation">.</span>gz\n</code></pre>\n<pre class="language-autoit"><code class="language-autoit">export PATH<span class="token operator">=</span><span class="token variable">$PATH</span><span class="token punctuation">:</span><span class="token operator">/</span>usr<span class="token operator">/</span><span class="token keyword">local</span><span class="token operator">/</span>go<span class="token operator">/</span>bin\n</code></pre>\n<p>查看版本</p>\n<pre class="language-autoit"><code class="language-autoit">go version\n</code></pre>\n<h3 id="%E4%B8%8B%E8%BD%BDhugo">下载hugo<a class="anchor" href="#%E4%B8%8B%E8%BD%BDhugo">§</a></h3>\n<p><a href="https://github.com/gohugoio/hugo/releases">https://github.com/gohugoio/hugo/releases</a></p>\n<p>下载 hugo_extended_0.80.0_Linux-64bit.deb</p>\n<p>终端输入</p>\n<pre class="language-autoit"><code class="language-autoit">sudo dpkg <span class="token operator">-</span>i hugo_extended_0<span class="token punctuation">.</span><span class="token number">80</span><span class="token punctuation">.</span>0_Linux<span class="token operator">-</span>64bit<span class="token punctuation">.</span>deb\n</code></pre>\n<p>查看版本</p>\n<pre class="language-autoit"><code class="language-autoit">hugo version\n</code></pre>\n<p>创建blog</p>\n<pre class="language-autoit"><code class="language-autoit">hugo new site blog\n</code></pre>\n<h3 id="%E5%AE%89%E8%A3%85%E4%B8%BB%E9%A2%98">安装主题<a class="anchor" href="#%E5%AE%89%E8%A3%85%E4%B8%BB%E9%A2%98">§</a></h3>\n<p>去官网下载主题 <a href="https://themes.gohugo.io">https://themes.gohugo.io</a></p>\n<p>我下载的是even <a href="https://themes.gohugo.io/hugo-theme-even">https://themes.gohugo.io/hugo-theme-even</a></p>\n<p>再推荐一个主题 <a href="https://github.com/uPagge/uBlogger">https://github.com/uPagge/uBlogger</a></p>\n<p>cd /blog</p>\n<pre class="language-autoit"><code class="language-autoit">git clone https<span class="token punctuation">:</span><span class="token operator">/</span><span class="token operator">/</span>github<span class="token punctuation">.</span>com<span class="token operator">/</span>olOwOlo<span class="token operator">/</span>hugo<span class="token operator">-</span>theme<span class="token operator">-</span>even themes<span class="token operator">/</span>even\n</code></pre>\n<p>在exampleSite目录找到config.toml和content 复制到D:\blog目录下</p>\n<p>在blog根目录下，终端输入下面代码</p>\n<pre class="language-autoit"><code class="language-autoit">hugo <span class="token operator">-</span><span class="token operator">-</span>theme<span class="token operator">=</span>even <span class="token operator">-</span><span class="token operator">-</span>baseUrl<span class="token operator">=</span><span class="token string">"<a class="token url-link" href="http://waimao365.github.io/">http://waimao365.github.io/</a>"</span> <span class="token operator">-</span><span class="token operator">-</span>buildDrafts\n</code></pre>\n<p>#even改成你的主题</p>\n<h3 id="%E6%9C%AC%E5%9C%B0%E9%A2%84%E8%A7%88">本地预览<a class="anchor" href="#%E6%9C%AC%E5%9C%B0%E9%A2%84%E8%A7%88">§</a></h3>\n<pre class="language-autoit"><code class="language-autoit">cd <span class="token operator">/</span>blog\nhugo\nhugo server\n</code></pre>\n<p><a href="http://localhost:1313">http://localhost:1313</a></p>\n<h3 id="%E5%BB%BA%E7%AB%8B%E6%9C%AC%E5%9C%B0%E5%92%8Cgithub%E4%BB%93%E5%BA%93%E7%9A%84%E8%BF%9E%E6%8E%A5">建立本地和github仓库的连接<a class="anchor" href="#%E5%BB%BA%E7%AB%8B%E6%9C%AC%E5%9C%B0%E5%92%8Cgithub%E4%BB%93%E5%BA%93%E7%9A%84%E8%BF%9E%E6%8E%A5">§</a></h3>\n<p>输入github的帐户名和邮箱</p>\n<pre class="language-autoit"><code class="language-autoit">git config <span class="token operator">-</span><span class="token operator">-</span><span class="token keyword">global</span> user<span class="token punctuation">.</span>name <span class="token string">"waimao365"</span>\ngit config <span class="token operator">-</span><span class="token operator">-</span><span class="token keyword">global</span> user<span class="token punctuation">.</span>email <span class="token string">"<a class="token email-link" href="mailto:88888@qq.com">88888@qq.com</a>"</span>\n</code></pre>\n<p>查看设置的用户名和密码</p>\n<pre class="language-autoit"><code class="language-autoit">git config <span class="token operator">-</span><span class="token operator">-</span>list\n</code></pre>\n<p>生成 SSH key 与 github 联系</p>\n<pre class="language-autoit"><code class="language-autoit">ssh<span class="token operator">-</span>keygen <span class="token operator">-</span>t rsa <span class="token operator">-</span>C “<span class="token number">888888</span><span class="token variable">@qq</span><span class="token punctuation">.</span>com”\n</code></pre>\n<p>一路回车  ubuntu设置显示隐藏文件，在用户目录找到.ssh</p>\n<p>打开id_rsa.pub，复制里面的内容。 然后登录github，如果没有就注册一个账号，登录后右上角 头像 -&gt; Settings —&gt; SSH nd GPG keys —&gt; New SSH key。把公钥(id_rsa.pub)粘贴到 key 中，填好 title 并点击 Add SSH key</p>\n<p>关联完之后可以在终端输入</p>\n<pre class="language-autoit"><code class="language-autoit">ssh git<span class="token variable">@github</span><span class="token punctuation">.</span>com\n</code></pre>\n<h3 id=""><a class="anchor" href="#">§</a></h3>\n<h3 id="%E4%B8%8A%E4%BC%A0%E5%88%B0github">上传到github<a class="anchor" href="#%E4%B8%8A%E4%BC%A0%E5%88%B0github">§</a></h3>\n<p>cd到 /public\n依次输入</p>\n<pre class="language-autoit"><code class="language-autoit">git init\ngit add <span class="token punctuation">.</span>\ngit commit <span class="token operator">-</span>m “yyyy<span class="token operator">/</span>mm<span class="token operator">/</span>dd<span class="token operator">-</span>hh<span class="token punctuation">:</span>mm”\ngit remote add origin git<span class="token variable">@github</span><span class="token punctuation">.</span>com<span class="token punctuation">:</span>waimao365<span class="token operator">/</span>lubutu18<span class="token punctuation">.</span>git\ngit push <span class="token operator">-</span>u origin master\n</code></pre>\n<h3 id="%E8%87%AA%E5%8A%A8%E9%83%A8%E7%BD%B2%E8%84%9A%E6%9C%AC">自动部署脚本<a class="anchor" href="#%E8%87%AA%E5%8A%A8%E9%83%A8%E7%BD%B2%E8%84%9A%E6%9C%AC">§</a></h3>\n<p><a href="https://www.dazhuanlan.com/2019/10/14/5da3e834e0c1d/">https://www.dazhuanlan.com/2019/10/14/5da3e834e0c1d/</a></p>\n<p><a href="https://github.com/coderzh/coderzh-hugo-blog/blob/master/deploy.py">https://github.com/coderzh/coderzh-hugo-blog/blob/master/deploy.py</a></p>\n<h2 id="%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF%E5%A4%84%E7%90%86">常见错误处理<a class="anchor" href="#%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF%E5%A4%84%E7%90%86">§</a></h2>\n<h3 id="fatal-%E8%BF%9C%E7%A8%8B-origin-%E5%B7%B2%E7%BB%8F%E5%AD%98%E5%9C%A8">fatal: 远程 origin 已经存在<a class="anchor" href="#fatal-%E8%BF%9C%E7%A8%8B-origin-%E5%B7%B2%E7%BB%8F%E5%AD%98%E5%9C%A8">§</a></h3>\n<p>此时只需要将远程配置删除，重新添加即可；</p>\n<p>git remote rm origin</p>\n<h3 id="-rejected--------master---master-non-fast-forward">! [rejected]        master -&gt; master (non-fast-forward)<a class="anchor" href="#-rejected--------master---master-non-fast-forward">§</a></h3>\n<p>本地生成ReadMe文件</p>\n<pre class="language-autoit"><code class="language-autoit">git pull <span class="token operator">-</span><span class="token operator">-</span>rebase origin master \ngit push origin master\n</code></pre>\n<p>如果不行，可以强制上传覆盖远程文件（慎用）</p>\n<pre class="language-autoit"><code class="language-autoit">git push <span class="token operator">-</span>f origin master\n</code></pre>\n<h2 id="%E5%85%B6%E4%BB%96">其他<a class="anchor" href="#%E5%85%B6%E4%BB%96">§</a></h2>\n<h3 id="%E5%AE%89%E8%A3%85typora%E5%86%99%E6%96%87%E7%AB%A0">安装typora写文章<a class="anchor" href="#%E5%AE%89%E8%A3%85typora%E5%86%99%E6%96%87%E7%AB%A0">§</a></h3>\n<p><a href="https://www.typora.io/#linux">https://www.typora.io/#linux</a></p>\n<h3 id="%E5%AE%89%E8%A3%85visual-studio-code%E5%86%99%E6%96%87%E7%AB%A0">安装Visual Studio Code写文章<a class="anchor" href="#%E5%AE%89%E8%A3%85visual-studio-code%E5%86%99%E6%96%87%E7%AB%A0">§</a></h3>\n<p><a href="https://code.visualstudio.com/">https://code.visualstudio.com/</a></p>\n<p><a href="https://code.visualstudio.com/">https://code.visualstudio.com/</a></p>\n<p>Visual Studio Code设置中文</p>\n<p>打开进入软件，Ctrl + Shift + P，切入到命令行模式。输入“Configure Language”</p>\n<h3 id="%E5%AE%89%E8%A3%85-notepad-%E7%BC%96%E8%BE%91%E4%B8%BB%E9%A2%98%E6%96%87%E4%BB%B6">安装 Notepad++ 编辑主题文件<a class="anchor" href="#%E5%AE%89%E8%A3%85-notepad-%E7%BC%96%E8%BE%91%E4%B8%BB%E9%A2%98%E6%96%87%E4%BB%B6">§</a></h3>\n<pre class="language-autoit"><code class="language-autoit">sudo add<span class="token operator">-</span>apt<span class="token operator">-</span>repository ppa<span class="token punctuation">:</span>notepadqq<span class="token operator">-</span>team<span class="token operator">/</span>notepadqq\nsudo apt<span class="token operator">-</span>get update\nsudo apt<span class="token operator">-</span>get install notepadqq\n</code></pre>\n<p>卸载方法:</p>\n<pre class="language-autoit"><code class="language-autoit">sudo apt<span class="token operator">-</span>get remove notepadqq\nsudo add<span class="token operator">-</span>apt<span class="token operator">-</span>repository <span class="token operator">-</span><span class="token operator">-</span>removeppa<span class="token punctuation">:</span>notepadqq<span class="token operator">-</span>team<span class="token operator">/</span>notepadqq\n</code></pre>'
        } }),
